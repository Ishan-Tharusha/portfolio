...
export const skillCategories: { id: string; label: string; image: string; imageAlt: string }[] = [
  ...
  { id: 'frontend', label: 'Front-End', image: '/html.png', imageAlt: 'Front-End' },
  { id: 'backend', label: 'Back-End', image: '/node-js.png', imageAlt: 'Back-End' },
  { id: 'tools', label: 'Tools & Technologies', image: '/git.svg', imageAlt: 'Tools' },
]

export const skills: Skill[] = [
  // Programming Languages
  { skill_name: 'C#', Image: '/icons.svg', width: 70, height: 70, category: 'languages' },
  { skill_name: 'Java', Image: '/icons.svg', width: 70, height: 70, category: 'languages' },
  ...
  { skill_name: 'CSS', Image: '/icons.svg', width: 70, height: 70, category: 'frontend' },
  { skill_name: 'Bootstrap', Image: '/icons.svg', width: 70, height: 70, category: 'frontend' },
  { skill_name: 'Tailwind CSS', Image: '/tailwind.png', width: 70, height: 70, category: 'frontend' },

  // Back-End Technologies
  { skill_name: '.NET', Image: '/icons.svg', width: 70, height: 70, category: 'backend' },
  { skill_name: 'Node.js', Image: '/node-js.png', width: 80, height: 80, category: 'backend' },
  { skill_name: 'Express.js', Image: '/icons.svg', width: 70, height: 70, category: 'backend' },
  ...
  { skill_name: 'Postman', Image: '/icons.svg', width: 70, height: 70, category: 'tools' },
