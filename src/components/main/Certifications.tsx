...
const certificationsData = [
  {
    Image: "/aws-academy-cert.png",
    title: "AWS Academy Graduate - Cloud Web Application Builder",
    description: "Validates knowledge in building and deploying web applications on AWS Cloud infrastructure",
    issued: "2024",
    links: [
      {
  ...
  },
  {
    ...
    description: "Covers foundational IT skills including hardware, software, networking, and security concepts",
    issued: "2023",
    links: [
      {
        link_name: "Certificate",
