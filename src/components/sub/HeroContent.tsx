      ...
      <motion.div variants={itemVariants} className="space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative bg-card/40 backdrop-blur-sm border border-primary/20 rounded-2xl p-6 shadow-2xl">
            <h2 title="Junior Full-Stack Developer" className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary via-blue-500 to-primary bg-clip-text text-transparent mb-3">
        ...
        >
          Passionate about building end-to-end web applications using ASP.NET Core, Node.js, React, and Spring Boot. Writing clean, maintainable code and continuously improving application performance.
        </motion.p>
      </motion.div>
